...
export default function Sidebar({ showSidebar, setShowSidebar }) {
  ...
  console.log(firstTimeStatus,"its firsttimeStatus..")
  ...
  useEffect(() => {
    ...
    if (user?.UserId) {
      console.log(user?.userId,"its user and userId....")
          ...
          category.name === "Support Tickets" ? (
            ...
            <Link key={index} href={category.link}>
              <div
                ...
                } ${category.name === "Upload Logo" ? "step1" : ""} ${
                  category.name === "Background Library" ? "step2" : ""
