...
<path class="elementor-shape-fill" d="M421.9,6.5c22.6-2.5,51.5,0.4,75.5,5.3c23.6,4.9,70.9,23.5,100.5,35.7c75.8,32.2,133.7,44.5,192.6,49.7
	...
	c21.2-8.1,52.2-18.2,79.7-24.2C399.3,7.9,411.6,7.5,421.9,6.5z" fill="#752ee4"></path>
      ...
      <div>
        ...
        <p className="my-4">
          TWe use Your Personal data to provide and improve the Service. By
        ...
        <section>
          ...
          <p className="my-4">
            ...
            products, services, marketing and your experienc
          </p>
          ...
          <ul className="px-4 md:px-6 lg:px-12">
            ...
            <li className="list-disc my-2">
              {" "}
              <span className="font-bold text-xl">With Your consent: </span> We
        ...
        Children’s Privacy
          ...
          <p className="my-4">
          Our Service does not address anyone under the age of 13. We do not knowingly collect personally identifiable information from anyone under the age of 13. If You are a parent or guardian and You are aware that Your child has provided Us with Personal Data, please contact Us. If We become aware that We have collected Personal Data from anyone under the age of 13 without verification of parental con  sent, We take steps to remove that information from Our servers.
            </p>
            <p className="my-4">
          ...
          If you have any questions about this Privacy Policy, You can contact us:
           ...
           <li className="list-disc"> By email: support@motorcut.com</li>
      </div>
