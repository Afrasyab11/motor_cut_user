  ...
  return (
    ...
    <div className="">
      ...
      <div className="grid grid-cols-2 gap-8 mt-2">
        <button
          className={`rounded-full p-1 sm:p-3 md:p-2 lg:p-2 xl:p-2 2xl:p-3 text-sm sm:text-md lg:text-[13px] xl:text-[14px] 2xl:text-[18px] ${
        ...
        <button
          className={`rounded-full p-1 sm:p-3 md:p-2 xl:p-2 2xl:p-4 text-sm sm:text-md lg:text-[13px] xl:text-[14px] 2xl:text-[18px] ${
   ...
   {payload.CutType=="Half Cut"  &&<div className="">
      <label className="text-sm sm:text-md  lg:text-[13px] xl:text-[14px] 2xl:text-[18px] mb-2">Trim Images</label>
      <div className="grid grid-cols-2 gap-8 mt-2">
        <button
          className={`rounded-full  sm:p-1 md:p-2 xl:p-2 2xl:p-2 text-sm sm:text-md lg:text-[13px] xl:text-[14px] 2xl:text-[18px] ${
    ...
    <div className="">
      <div className="text-center">
        <button
          ...
          className="border rounded-full border-black px-4 py-1 md:px-6 lg:px-6 xl:px-6 2xl:px-6 3xl:px-16 md:py-2 xl:p-2 2xl:p-4 text-sm sm:text-md lg:text-[13px] xl:text-[14px] 2xl:text-[18px]"
        >
          Upload Images
        </button>
      </div>
