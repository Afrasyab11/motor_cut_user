...
export const userProfileSchema = z.object({
  ...
  email: z
    ...
    .regex(/^\+?\d+$/, { message: "Mobile number must be numeric and can include a leading '+'" })
    .refine((val) => val.replace('+', '').length >= 10, { message: "Mobile number minimum should be 10 digits" }),
